...
public class Area
{
	...
	public Location getCenter(int yOffset)
	{
		...
		CreeperProtectPlugin.getInstance().getLogger().info("Calculated center of " + Utility.locationAsString(pos1) + " to " + Utility.locationAsString(pos2) + " as " + Utility.locationAsString(volume % 2 == 0 ? midpointBase.toBlockLocation() : midpointBase.toCenterLocation()));
